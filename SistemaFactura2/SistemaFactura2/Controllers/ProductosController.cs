...
namespace SistemaFactura2.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDProductos,Nombre,Precio")] Productos productos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDProductos,Nombre,Precio")] Productos productos)
        {
            if (ModelState.IsValid)
            {
